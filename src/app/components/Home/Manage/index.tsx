      ...
      <div className='container mx-auto max-w-7xl px-4'>
          ...
          <div className='flex flex-col sm:flex-row gap-5 md:justify-evenly mt-20 items-start mx-auto'>
            <div className='flex gap-5 items-center justify-center md:justify-start'>
              <Image
                ...
                height={14}
              />
              <p className='text-lg font-semibold'>Website Creation</p>
            </div>
            <div className='flex gap-5 items-center justify-center md:justify-start'>
              <Image
                src='/images/manage/right.svg'
                ...
                height={14}
              />
              <p className='text-lg font-semibold'>Brand Design</p>
            </div>
            <div className='flex gap-5 items-center justify-center md:justify-start'>
              <Image
                src='/images/manage/right.svg'
                ...
                height={14}
              />
              <p className='text-lg font-semibold'>Social Media Management</p>
            </div>
          </div>
        </div>
        {/*  */}
        <div className='mt-6 relative'>
          ...
          <div className='flex items-center justify-center'>
            <p className='text-sm font-medium mr-5'>Naira (₦)</p>
            <Switch
              checked={enabled}
            ...
            <p className='text-sm font-medium ml-5'>Dollar ($)</p>
          </div>
        </div>
